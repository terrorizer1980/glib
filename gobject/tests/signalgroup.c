...
test_signal_group_changing_target (void)
{
  ...
  g_assert (g_signal_group_get_target (group) == (GObject *)target1);
  ...
  g_assert (g_signal_group_get_target (group) == (GObject *)target2);
...
test_signal_group_connect_object (void)
{
  ...
  g_assert (g_signal_group_get_target (group) == (GObject *)NULL);
  g_signal_group_set_target (group, target);
  g_assert (g_signal_group_get_target (group) == (GObject *)target);
